import { screen_modules_size_X, mediaResponsive } from '/static/js/utils.js';
...
export class BoxAnimates {
    ...
    html_svg_circle(num) {
        const svg_htmls = [
            ...
            `<div id="circle_hover_options" class="graphic options"><div class="menu"><a href="/templates/networking.html">Networking</a><a>Porfolio</a><a>Research</a></div></div>`
        ]
