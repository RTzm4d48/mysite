...
class BoxAnimates {
    ...
    pinter_circle() {
        ...
        document.getElementById("circle_hover").addEventListener('mouseover', (event) => {
            console.log('hover');
        });
    ...
    html_svg_circle(num) {
        const svg_htmls = [
            ...
            `<div class="graphic circle_4"><svg viewBox="0 0 274 274"><path d="M87.61,187.48a71,71,0,0,0,100.41,0l-11.31-11.31a55,55,0,0,1-77.78,0Z"/><path d="M68.91,157.32a71,71,0,0,1,46.92-88.77l4.72,15.29A55,55,0,0,0,84.2,152.61Z"/><path d="M154.29,84.36a55,55,0,0,1,35.64,69.14l15.24,4.87a71,71,0,0,0-46-89.25Z"/></svg></div>`,
            `<div class="graphic"><svg viewBox="0 0 274 274"><path d="M163.82,137.28a26,26,0,1,1-26-26A26,26,0,0,1,163.82,137.28Zm-26-22a22,22,0,1,0,22,22A22,22,0,0,0,137.82,115.28Z"/></svg></div>`,
            ...
            `<div class="graphic circle_7"><svg viewBox="0 0 274 274"><polygon points="168.82 136.53 168.82 135.03 183.82 126.78 183.82 129.78 182.82 130.53 182.82 136.53 168.82 136.53"/><polygon points="168.82 138.03 168.82 139.53 183.82 147.78 183.82 144.78 182.82 144.03 182.82 138.03 168.82 138.03"/><polygon points="106.82 136.53 106.82 135.03 91.82 126.78 91.82 129.78 92.82 130.53 92.82 136.53 106.82 136.53"/><polygon points="106.82 138.03 106.82 139.53 91.82 147.78 91.82 144.78 92.82 144.03 92.82 138.03 106.82 138.03"/></svg></div>`,
            `<div class="graphic circle_8"><svg viewBox="0 0 274 274"><path d="M134.82,216.81a79.61,79.61,0,0,0,69.59-35.87l4.05,2.67a84.44,84.44,0,0,1-73.83,38Z"/></svg></div>`,
            `<div class="graphic circle_9"><svg viewBox="0 0 274 274"><path d="M151.85,48.64a89.74,89.74,0,0,1,74.6,102.67l-5.08-.81A84.59,84.59,0,0,0,151,53.73Z"/></svg></div>`,
            ...
            `<div id="circle_hover" class="graphic circle_11"><svg viewBox="0 0 274 274"><path d="M78.11,70.2A89.4,89.4,0,0,0,52,110.73a90.69,90.69,0,0,0-3.1,13.6l-5.41-.79a95.65,95.65,0,0,1,31-57.43Z"/></svg></div>`,
        ]
